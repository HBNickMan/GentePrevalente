...
export function EmpresaForm() {
    ...
    return (
        <Container title='Empresas'>
            <h3 className="p-4 text-white">Administracion/Agregar Empresas</h3>
            <div className="container d-flex justify-content-center p-4">
                <form onSubmit={handleSubmit} className="p-5 p-5-mio mt-8 space-y-6 bg-white rounded-lg shadow-lg">
                    <div className="d-flex justify-content-end">
                        ...
                        <div className="end-0 px-5 invisible">
                    ...
                    <div className="grid grid-cols-2">
                        ...
                        <label className='text-gray-500 '>
                            <button onClick={() => {
                                ...
                                className='btn btn-success bg-blue-500 hover:bg-blue-700 py-2 px-4 mx-2 rounded focus:outline-none focus:shadow-outline font-bold text-black'>
                                <i aria-hidden={true} className="text-2xl text-blue-500 align-middle fas fa-paperclip"></i> Ver archivos adjuntos
                            </button>
                        </label>
                    </div>
                    <div className="btn btn-primary flex flex-col py-2 md:visible">
                        <button type='submit' className='bg-blue-500 hover:bg-blue-700 py-2 px-4 mx-2 rounded focus:outline-none focus:shadow-outline font-bold text-black'>
                            <i aria-hidden={true} className="text-2xl text-red-500 align-middle fas fa-times-circle"></i> Guardar
                        </button>
                    </div>
                    <div className="btn btn-danger mx-2 flex flex-col py-2 md:visible">
                        <button className='bg-blue-500 hover:bg-blue-700 py-2 px-4 mx-2 rounded focus:outline-none focus:shadow-outline font-bold text-black'>
                            <i aria-hidden={true} className="text-2xl text-red-500 align-middle fas fa-times-circle"></i> Cerrar
                        </button>
                    </div>
                </form>
            </div>
            ...
            >
                <Contenido>
                    ...
                    <p>En esta Seccion van los Archivos q se cargan al momento de registro de la empresa</p>
                    <Boton onClick={() => {
                                cambiarEstadoModal(!estadoModal);
                            }}>Aceptar</Boton>
                </Contenido>
